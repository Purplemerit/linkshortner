...
export function Footer() {
    return (
        <footer className="bg-white border-t border-gray-100 px-4 sm:px-6 lg:px-8 py-16">
            <div className="max-w-7xl mx-auto grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 mb-16">
                <div className="col-span-2 lg:col-span-2">
                    <h4 className="font-bold text-xl mb-6">short.link</h4>
                    <p className="text-gray-500 text-sm max-w-xs mb-6">
                        The privacy-first URL shortener built for the modern web. Helping brands build stronger connections since 2024.
                    </p>
                    <div className="flex gap-4">
                        {/* Social Icons Placeholders */}
                        <div className="w-8 h-8 bg-gray-100 rounded-full flex items-center justify-center hover:bg-purple-100 hover:text-purple-600 transition-colors cursor-pointer">
                ...
                <div>
                    ...
                    <ul className="space-y-4 text-sm text-gray-500">
                        ...
                        <li><Link href="/changelog" className="hover:text-purple-600 transition-colors">Changelog</Link></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul className="space-y-4 text-sm text-gray-500">
                        ...
                        <li><Link href="/developers" className="hover:text-purple-600 transition-colors">Develop API</Link></li>
            ...
            <div className="max-w-7xl mx-auto border-t border-gray-100 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
                <p className="text-gray-400 text-sm">© 2025 short.link inc. All rights reserved.</p>
